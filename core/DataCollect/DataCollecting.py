...
if os.path.isfile(train_path):
    ...
    while True:
        try:
            ...
            # current_memory_usage data
            memory_usage = psutil.virtual_memory()

            print(cur_date, tot_process_number, tot_thread_number, memory_usage.percent)

            wr.writerow([cur_date, tot_process_number, tot_thread_number, memory_usage.percent])
